...
// Initial state - array kosong untuk users
const initialState = {
    users: [], // Array kosong yang akan diisi data API
    loading: false,
    error: null,
};
...
export const fetchUsers = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            return response; // Data users dari API
        } catch (error) {
...
export const resetUserPassword = createAsyncThunk(
    ...
    async ({ userId, newPassword }, { rejectWithValue, getState }) => {
        try {
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchUsers.fulfilled, (state, action) => {
                state.loading = false;
                state.users = action.payload; // Simpan data users dari API
                state.error = null;
            })
